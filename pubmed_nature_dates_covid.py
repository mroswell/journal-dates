...
def main():
    target_url = "https://pubmed.ncbi.nlm.nih.gov/?term=Nature%5BJournal%5D+%28SARS-COV-2+OR+COVID-19%29&filter=pubt.classicalarticle&filter=pubt.clinicalstudy&filter=pubt.clinicaltrialphasei&filter=pubt.clinicaltrialphaseii&filter=pubt.clinicaltrialphaseiii&filter=pubt.clinicaltrialphaseiv&filter=pubt.comparativestudy&filter=pubt.controlledclinicaltrial&filter=pubt.evaluationstudy&filter=pubt.multicenterstudy&filter=pubt.observationalstudy&filter=pubt.pragmaticclinicaltrial&filter=pubt.technicalreport&size=100"  # Replace with the URL of the webpage you want to scrape
